# Supabase Integration for the Client Side (Windows)
...
18. Click on `Data API`.
19. Copy the `Project URL`.
20. Now, go to the project and create a `.env` file in the `client` folder.
